...
const DEBOUNCE_MS = 400 // mesmo valor da busca no TMDb (etapa 04) -- consistência de sensação entre buscas

// Debounce de 400ms antes de refletir na URL (§ etapa 05): digitar rápido não deve
// empilhar uma entrada de histórico por tecla, nem disparar uma requisição por tecla.
